...
// {
// 	commandsSet.pushBack("open");
// 	commandsSet.pushBack("close");
//     commandsSet.pushBack("save");
// 	commandsSet.pushBack("save as");
//     commandsSet.pushBack("up");
// 	commandsSet.pushBack("down");
// 	commandsSet.pushBack("left");
// 	commandsSet.pushBack("right");
